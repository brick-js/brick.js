...
[![Coverage Status](https://coveralls.io/repos/github/brick-js/brick.js/badge.svg?branch=master&foo=bar)](https://coveralls.io/github/brick-js/brick.js?branch=master)
